...
class WindowCopySearchCell(QWidget):
    def __init__(self):
        super(WindowCopySearchCell, self).__init__()
    ...
    def btn_start_work(self):
        ...
        print(cell_to, text)
        read = write_excel_document.copy_search_text_to_other_cell(excel_document, cell_from, cell_to, text)
        for string in read:
