...
class WindowAddEndRow(QWidget):
    def __init__(self):
        super(WindowAddEndRow, self).__init__()
    ...
    def btn_start_work(self):
        ...
        print(cell_to, text)
        read = write_excel_document.add_text_to_cell(document=excel_document, cell=cell_to, text=text, position='end')
        for string in read:
