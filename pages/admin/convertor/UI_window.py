...
# Form implementation generated from reading ui file '.\pages\admin\convertor\UI_window.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_3.setMinimumSize(QtCore.QSize(75, 30))
        ...
        self.comboBoxUnits = QtWidgets.QComboBox(self.widget_2)
        self.comboBoxUnits.setObjectName("comboBoxUnits")
        self.horizontalLayout.addWidget(self.comboBoxUnits)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Колонка"))
        self.lineEdit_from.setPlaceholderText(_translate("Form", "AC"))
        self.label_3.setText(_translate("Form", "Результат"))
        self.lineEdit_to.setPlaceholderText(_translate("Form", "AF"))
        self.label.setText(_translate("Form", "Конвертировать в "))
